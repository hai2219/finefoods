...
<div id="home-slide" class="owl-carousel owl-theme">
     <?php $slide = new WP_Query( array( 'post_type' => 'home_slideshow','orderby' => 'date', 'order' => 'DESC' ) ); ?>
...
?>
    <div class="item"><img src="<?php print $image?>" alt="" align="center" valign="middle"></div>
     <?php } endwhile; ?>
     <?php endif; ?>
